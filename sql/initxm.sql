...
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler','DY-2019032812111572839527021',1572839574512,15000);
...
INSERT INTO `sys_config` VALUES (1,'主框架页-默认皮肤样式名称','sys.index.skinName','skin-green','Y','admin','2018-03-16 11:33:00','admin','2019-10-12 08:47:17','蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow'),(2,'用户管理-账号初始密码','sys.user.initPassword','123456','Y','admin','2018-03-16 11:33:00','ry','2018-03-16 11:33:00','初始化密码 123456');
...
INSERT INTO `sys_role` VALUES (1,'管理员','admin',1,'1','0','0','admin','2018-03-16 11:33:00','admin','2019-10-31 09:32:11','管理员',0),(2,'公司管理员','common',2,'2','0','0','admin','2018-03-16 11:33:00','admin','2019-10-31 10:59:23','普通角色',1),(3,'拉长','lz',2,'1','0','0','13559095980','2019-11-04 11:48:45','','2019-11-04 11:50:32',NULL,2),(4,'员工','yg',4,'1','0','0','13559095980','2019-11-04 11:50:50','',NULL,NULL,2);
...
INSERT INTO `sys_role_menu` VALUES (2,1),(2,100),(2,101),(2,1000),(2,1001),(2,1002),(2,1003),(2,1004),(2,1005),(2,1006),(2,1007),(2,1008),(2,1009),(2,1010),(2,1011),(3,1),(3,101),(3,1007),(3,1008),(3,1009),(3,1010),(3,1011),(4,1),(4,100),(4,1000);
...
CREATE TABLE `sys_user` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) DEFAULT '' COMMENT '备注',
  `tag` varchar(45) DEFAULT NULL COMMENT '公司管理标记(0、其他，1、公司管理员创建者)',
  PRIMARY KEY (`user_id`)
...
INSERT INTO `sys_user` VALUES (1,1,103,'admin','若依','00','ry@163.com','15888888888','1','','403565e2167a81357c4270dec083c685','4981ef','0','0','127.0.0.1','2019-11-04 11:47:48','admin','2018-03-16 11:33:00','ry','2019-11-04 11:47:47','管理员',NULL),(2,1,105,'ry','若依','00','ry@qq.com','15666666666','1','','8e6d98b90472783cc73c17047ddccf36','222222','0','0','127.0.0.1','2018-03-16 11:33:00','admin','2018-03-16 11:33:00','admin','2019-10-31 09:32:51','测试员',NULL),(3,2,NULL,'13559095980','普通用户','00','809268719@qq.com','','0','2387ce24a8d21aff798d4ff99b8186f5.jpg','7fda504e0fa90ee0de7ae5588976a101','44c664','0','0','127.0.0.1','2019-11-04 11:52:17','','2019-11-04 11:12:41','13559095980','2019-11-04 11:52:45','','1');
...
INSERT INTO `sys_user_online` VALUES ('2bffec7f-69b0-43be-a790-778cbb232839','13559095980',NULL,'127.0.0.1','内网IP','Chrome','Windows 7','on_line','2019-11-04 11:52:12','2019-11-04 11:52:17',1800000),('9a6d15a1-56dd-4839-9596-4bdbac498475','13559095980',NULL,'127.0.0.1','内网IP','Chrome','Windows 7','on_line','2019-11-04 11:38:01','2019-11-04 11:38:06',1800000);
...
INSERT INTO `sys_user_role` VALUES (1,1),(3,2);
...
CREATE TABLE `tab_company` (
  ...
  `com_address` varchar(45) DEFAULT NULL COMMENT '公司地址',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `tab_company` VALUES (1,'超级管理员',NULL,'2019-10-31 10:10:16'),(2,'测试技术有限公司',NULL,'2019-11-04 11:12:42');
...
-- Dump completed on 2019-11-04 11:54:42
